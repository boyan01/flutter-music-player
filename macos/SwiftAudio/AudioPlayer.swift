...
public class AudioPlayer: AVPlayerWrapperDelegate {
    ...
    public var bufferDuration: TimeInterval {
        get {
            return wrapper.bufferDuration
        }
        set {
            _wrapper.bufferDuration = newValue
        }
    }
    ...
    public var timeEventFrequency: TimeEventFrequency {
        get {
            return wrapper.timeEventFrequency
        }
        set {
            _wrapper.timeEventFrequency = newValue
        }
    }
    ...
    public var automaticallyWaitsToMinimizeStalling: Bool {
        get {
            return wrapper.automaticallyWaitsToMinimizeStalling
        }
        set {
            _wrapper.automaticallyWaitsToMinimizeStalling = newValue
        }
    }
    ...
    public var volume: Float {
        ...
        set {
            _wrapper.volume = newValue
        }
    }

    public var isMuted: Bool {
        get {
            return wrapper.isMuted
        }
        set {
            _wrapper.isMuted = newValue
        }
    }
